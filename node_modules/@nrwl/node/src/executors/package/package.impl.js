...
function packageExecutor(options, context) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { target, dependencies } = buildable_libs_utils_1.calculateProjectDependencies(project_graph_1.readCachedProjectGraph('4.0'), context.root, context.projectName, context.targetName, context.configurationName);
