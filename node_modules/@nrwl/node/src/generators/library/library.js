...
function libraryGenerator(tree, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const libraryInstall = yield generators_1.libraryGenerator(tree, Object.assign(Object.assign({}, schema), { importPath: options.importPath, testEnvironment: 'node', skipFormat: true, setParserOptionsProject: options.setParserOptionsProject }));
...
function createFiles(tree, options) {
    const { className, name, propertyName } = devkit_1.names(options.fileName);
    devkit_1.generateFiles(tree, path_1.join(__dirname, './files/lib'), options.projectRoot, Object.assign(Object.assign({}, options), { className,
        name,
        propertyName, tmpl: '', offsetFromRoot: devkit_1.offsetFromRoot(options.projectRoot) }));
