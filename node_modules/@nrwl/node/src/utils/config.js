...
exports.getBaseWebpackPartial = exports.OUT_FILENAME_TEMPLATE = exports.OUT_FILENAME = void 0;
...
function getBaseWebpackPartial(options) {
    ...
    const { options: compilerOptions } = typescript_1.readTsConfig(options.tsConfig);
    ...
    const { compilerPluginHooks, hasPlugin } = load_ts_plugins_1.loadTsPlugins(options.tsPlugins);
