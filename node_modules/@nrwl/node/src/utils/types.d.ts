import type { CustomTransformerFactory, Node, Program, TransformerFactory } from 'typescript';
...
declare type Transformer = TransformerFactory<Node> | CustomTransformerFactory;
export interface TsPlugin {
    name: string;
    options: Record<string, unknown>;
}
export declare type TsPluginEntry = string | TsPlugin;
export interface CompilerPlugin {
    before?: (options?: Record<string, unknown>, program?: Program) => Transformer;
    after?: (options?: Record<string, unknown>, program?: Program) => Transformer;
    afterDeclarations?: (options?: Record<string, unknown>, program?: Program) => Transformer;
}
