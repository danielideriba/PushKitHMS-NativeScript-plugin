...
const fs = require("fs");
function calculateDefaultProjectName(cwd, root, workspaceConfiguration, nxJson) {
    var _a;
    ...
    return (((_a = nxJson.cli) === null || _a === void 0 ? void 0 : _a.defaultProjectName) ||
...
function parseRunOneOptions(root, workspaceJsonConfiguration, nxJson, args) {
    var _a;
    const defaultProjectName = calculateDefaultProjectName(process.cwd(), root, workspaceJsonConfiguration, nxJson);
    ...
    // we need both to be able to run a target, no tasks runner
    const p = workspaceJsonConfiguration.projects &&
