...
Zone.__load_patch('nativescript_patchMethod', (global, Zone, api) => {
    api.patchMethod = function patchMethod(target, name, patchFn) {
        let proto = target;
