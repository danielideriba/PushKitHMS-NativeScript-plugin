import { View, LayoutBase, ContentView, ProxyViewContainer, Page, platformNames, GridLayout, Application, Trace, TextView, Color, removeTaggedAdditionalCSS, Utils, profile, AbsoluteLayout, ActivityIndicator, Button, DatePicker, DockLayout, Frame, HtmlView, Image, Label, ListPicker, ListView, Placeholder, Progress, Repeater, RootLayout, ScrollView, SearchBar, SegmentedBar, SegmentedBarItem, Slider, StackLayout, FlexboxLayout, Switch, TabView, TextField, TimePicker, WebView, WrapLayout, FormattedString, Span, unsetValue, addTaggedAdditionalCSS, getViewById, Observable, ViewBase, ActionItem, NavigationButton, ActionBar, ObservableArray, TabViewItem, Device, knownFolders, File, KeyframeAnimation, animationTimingFunctionConverter, parseKeyframeDeclarations, CSSHelper, eachDescendant, CssAnimationProperty, path } from '@nativescript/core';
import * as i0 from '@angular/core';
import { InjectionToken, Inject, ComponentRef, Injectable, PlatformRef, NgModuleRef, NgZone, Sanitizer, createPlatformFactory, platformCore, ElementRef, Directive, TemplateRef, ViewContainerRef, EventEmitter, ComponentFactoryResolver, Renderer2, Output, NgModule, ApplicationRef, Injector, Optional, Component, ChangeDetectorRef, ViewChild, ViewEncapsulation, Input, ɵisListLikeIterable, ɵmarkDirty, ChangeDetectionStrategy, forwardRef, IterableDiffers, ContentChild, HostListener, Host, NO_ERRORS_SCHEMA, ErrorHandler, SkipSelf, ɵINJECTOR_SCOPE, RendererFactory2, ApplicationModule, Type, ContentChildren, Attribute, isDevMode } from '@angular/core';
...
import { HttpXhrBackend, HttpResponse, HttpErrorResponse, HttpBackend, HttpClientModule } from '@angular/common/http';

const getClassName = (instance) => instance.constructor.name;
const ɵ0$9 = getClassName;
...
const ɵ0$8 = (v) => v.moduleType === 'main' && v.reason === 'hotreload', ɵ1$3 = (v) => v.reference;
/**
 * @deprecated
 */
const onBeforeLivesync = preAngularDisposal$.pipe(filter(ɵ0$8), map(ɵ1$3));
const ɵ2$3 = (v) => v.moduleType === 'main', ɵ3$2 = (v) => ({ moduleRef: v.reference });
/**
 * @deprecated
 */
const onAfterLivesync = postAngularBootstrap$.pipe(filter(ɵ2$3), map(ɵ3$2));
if (module['hot']) {
    module['hot'].decline();
...
const ɵ0$7 = defaultPageFactory;
const defaultPageFactoryProvider = { provide: PAGE_FACTORY, useValue: ɵ0$7 };
 ...
 * application context.
 */
class NativeScriptDomPortalOutlet extends BasePortalOutlet {
    constructor(
...
const ɵ0$5 = function addStyleToCss(style, tag) {
    if (tag) {
...
const addStyleToCss = profile('"renderer".addStyleToCss', ɵ0$5);
...
const ɵ1$2 = replaceNgAttribute;
const ɵ2$2 = function addScopedStyleToCss(style, tag) {
    if (tag) {
        addTaggedAdditionalCSS(style, tag);
    }
    else {
...
const addScopedStyleToCss = profile(`"renderer".addScopedStyleToCss`, ɵ2$2);
...
const ɵ3$1 = insertActionItemBefore;
...
NSLocationStrategy.ɵprov = i0.ɵɵdefineInjectable({ factory: function NSLocationStrategy_Factory() { return new NSLocationStrategy(i0.ɵɵinject(FrameService), i0.ɵɵinject(START_PATH, 8)); }, token: NSLocationStrategy, providedIn: "root" });
...
const ɵ0$2 = createKeyframeAnimationInfo;
