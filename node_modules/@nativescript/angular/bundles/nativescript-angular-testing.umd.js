(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nativescript/core'), require('@angular/core'), require('@angular/core/testing'), require('@nativescript/angular'), require('@angular/platform-browser-dynamic/testing')) :
    typeof define === 'function' && define.amd ? define('@nativescript/angular/testing', ['exports', '@nativescript/core', '@angular/core', '@angular/core/testing', '@nativescript/angular', '@angular/platform-browser-dynamic/testing'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.nativescript = global.nativescript || {}, global.nativescript.angular = global.nativescript.angular || {}, global.nativescript.angular.testing = {}), global['ns-core'], global.ng.core, global.ng.core.testing, global.nativescript.angular, global.ng.platformBrowserDynamic.testing));
}(this, (function (exports, core, core$1, testing, angular, testing$1) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     * module.
     */
    var NATIVESCRIPT_TESTING_PROVIDERS = __spreadArray(__spreadArray([], __read(angular.COMMON_PROVIDERS)), [{ provide: angular.APP_ROOT_VIEW, useFactory: ɵ0 }, { provide: testing.TestComponentRenderer, useClass: NativeScriptTestComponentRenderer }]);
    /**
    ...
    NativeScriptTestingModule.decorators = [
        { type: core$1.NgModule, args: [{
                    exports: [angular.NativeScriptModule],
        ...
        return function (done) {
            ...
            if (entryComponents.length === 0) {
                testing.TestBed.configureTestingModule({
                    ...
                    imports: __spreadArray([angular.NativeScriptModule], __read(imports)),
                });
            }
            else {
