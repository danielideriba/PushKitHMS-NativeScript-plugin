    ...
    return new Promise((resolve, reject) => {
        ...
        if (isBuild) {
            ...
            if (buildTarget && buildTarget.options) {
                options = Object.assign(Object.assign({}, options), buildTarget.options);
            }
        }
        ...
        if (context.target.configurations) {
            ...
            if (isBuild) {
                ...
                if (targetBuildConfig) {
                    options = Object.assign(Object.assign({}, options), targetBuildConfig);
                }
            }
            if (configOptions) {
        ...
        if (options.clean) {
            ...
            if ((options === null || options === void 0 ? void 0 : options.force) !== false) {
...
exports.default = devkit_1.convertNxExecutor(runBuilder);
