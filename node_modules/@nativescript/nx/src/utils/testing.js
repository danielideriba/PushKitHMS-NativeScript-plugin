...
const testRunner = new testing_2.SchematicTestRunner('@nativescript/nx', path_1.join(__dirname, '../../collection.json'));
...
function createApp(tree, appName) {
    const { fileName } = workspace_1.names(appName);
    return callRule(workspace_2.updateWorkspace((workspace) => {
